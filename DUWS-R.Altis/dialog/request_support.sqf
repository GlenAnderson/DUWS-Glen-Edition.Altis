    ...
    case 5: {
        if (commandpointsblu1 >= 1) then {
            if (!support_armory_available) then {
                ...
                hq_blu1 addaction ["<t color='#ff0066'>Armory (Virtual Arsenal)</t>","bisArsenal.sqf", "", 0, true, true, "", "_this == player"];
                {
                    _x addaction ["<t color='#ff0066'>Armory (Virtual Arsenal)</t>","bisArsenal.sqf", "", 0, true, true, "", "_this == player"];
